...
direction: db 4
snakeLength: dw 1
message db 'Your computer has been infected.', 0Dh, 0Ah
		db 'To fix it, win this game of snake.', 0Dh, 0Ah, 0Dh, 0Ah
		db 'Press P to proceed', 0Dh, 0Ah, 0
...
print_string:
	...
	cmp al, 'P'
	jne .print_char
	mov ah, 0Ah  ; Green text on black background
	jmp .print
.print_char:
	mov ah, 0Eh  ; Default color
.print:
	int 10h
	jmp print_string
.done:
